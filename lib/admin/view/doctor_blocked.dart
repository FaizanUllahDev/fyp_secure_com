...
class AdminBlockedList extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(
        () => Get.find<AdminController>().blockedList.length > 0
            ? DoctorListBlock(Get.find<AdminController>().blockedList)
...
class DoctorListBlock extends StatelessWidget {
  final RxList<DoctorModel> list;
  DoctorListBlock(this.list);
  @override
  Widget build(BuildContext context) {
          ...
          return Slidable(
            ...
            secondaryActions: <Widget>[
              Container(
                  ...
                  child: InkWell(
                    onTap: () => Get.find<AdminController>().updateDoctorStatus(
                        list[index].number, "Accepted", index),
                    child: Center(
                      child: Column(
