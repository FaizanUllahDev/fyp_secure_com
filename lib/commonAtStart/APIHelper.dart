...
const API_IP = '192.168.0.107';
const PORT = 80;
const APIHOST = 'http://$API_IP:$PORT/chat_app/pages/';

const FILES_IMG = 'http://$API_IP:$PORT/chat_app/pages/assets/img/';
const FILES_MP3 = 'http://$API_IP:$PORT/chat_app/pages/assets/audio/';
const FILES_ccd = 'http://$API_IP:$PORT/chat_app/pages/assets/ccd/';
